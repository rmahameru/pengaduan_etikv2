...
<img src="{{ asset('assets/img/Logo Poltekkes Kemenkes Surabaya.png') }}" alt="Logo" style="height: 40px; margin-right: 10px;">
      <h1 class="logo me-auto"><a href="/">POLKESBAYA BERETIKA</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0 ">
        ...
        <ul>
          <li><a class="nav-link scrollto"style="font-family: Arial;"{{ (request()->is('/pengaduan')) ? 'active' : '' }}" href="{{ route('pengaduan')}}">Buat Pengaduan</a></li>
          {{-- <li><a class="nav-link scrollto {{ (request()->is('tentang')) ? 'active' : '' }}" href="{{ url('tentang')}}">Tentang</a></li> --}}
          <li><a class="nav-link scrollto "style="font-family: Arial;"{{ (request()->is('pengaduan.laporan')) ? 'active' : '' }}" href="{{ route('pengaduan.laporan', 'saya')}}">Pengaduan Saya</a></li>
        </ul>
